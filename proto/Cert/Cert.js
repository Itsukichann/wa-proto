...
$root.Cert = (function() {
    ...
    Cert.CertChain = (function() {
        ...
        CertChain.decode = function (reader, length, _end, _depth, _target) {
            ...
            message = _target || new $root.Cert.CertChain();
        ...
        CertChain.NoiseCertificate = (function() {
            ...
            NoiseCertificate.decode = function (reader, length, _end, _depth, _target) {
                ...
                message = _target || new $root.Cert.CertChain.NoiseCertificate();
                while (reader.pos < end) {
                    var start = reader.pos;
                    var tag = reader.tag();
                    if (tag === _end) {
            ...
            NoiseCertificate.Details = (function() {
                ...
                Details.decode = function (reader, length, _end, _depth, _target) {
                    ...
                    message = _target || new $root.Cert.CertChain.NoiseCertificate.Details();
                    while (reader.pos < end) {
                        var start = reader.pos;
                        var tag = reader.tag();
                        if (tag === _end) {
    ...
    Cert.NoiseCertificate = (function() {
        ...
        NoiseCertificate.decode = function (reader, length, _end, _depth, _target) {
            ...
            message = _target || new $root.Cert.NoiseCertificate();
            while (reader.pos < end) {
                var start = reader.pos;
                var tag = reader.tag();
                if (tag === _end) {
        ...
        NoiseCertificate.Details = (function() {
            ...
            Details.decode = function (reader, length, _end, _depth, _target) {
                ...
                message = _target || new $root.Cert.NoiseCertificate.Details();
                while (reader.pos < end) {
                    var start = reader.pos;
                    var tag = reader.tag();
                    if (tag === _end) {
