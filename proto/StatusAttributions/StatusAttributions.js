...
var $Object = $util.global.Object, $undefined = $util.global.undefined, $Error = $util.global.Error, $RangeError = $util.global.RangeError, $TypeError = $util.global.TypeError, $String = $util.global.String, $Boolean = $util.global.Boolean;
...
$root.StatusAttributions = (function() {
    ...
    StatusAttributions.StatusAttribution = (function() {
        ...
        StatusAttribution.decode = function (reader, length, _end, _depth, _target) {
            ...
            message = _target || new $root.StatusAttributions.StatusAttribution();
        ...
        StatusAttribution.AiCreatedAttribution = (function() {
            ...
            AiCreatedAttribution.decode = function (reader, length, _end, _depth, _target) {
                ...
                message = _target || new $root.StatusAttributions.StatusAttribution.AiCreatedAttribution();
                while (reader.pos < end) {
                    var start = reader.pos;
                    var tag = reader.tag();
                    if (tag === _end) {
        ...
        StatusAttribution.ExternalShare = (function() {
            ...
            ExternalShare.decode = function (reader, length, _end, _depth, _target) {
                ...
                message = _target || new $root.StatusAttributions.StatusAttribution.ExternalShare();
                while (reader.pos < end) {
                    var start = reader.pos;
                    var tag = reader.tag();
                    if (tag === _end) {
        ...
        StatusAttribution.GroupStatus = (function() {
            ...
            GroupStatus.decode = function (reader, length, _end, _depth, _target) {
                ...
                message = _target || new $root.StatusAttributions.StatusAttribution.GroupStatus();
                while (reader.pos < end) {
                    var start = reader.pos;
                    var tag = reader.tag();
                    if (tag === _end) {
        ...
        StatusAttribution.Music = (function() {
            ...
            Music.decode = function (reader, length, _end, _depth, _target) {
                ...
                message = _target || new $root.StatusAttributions.StatusAttribution.Music();
                while (reader.pos < end) {
                    var start = reader.pos;
                    var tag = reader.tag();
                    if (tag === _end) {
        ...
        StatusAttribution.RLAttribution = (function() {
            ...
            RLAttribution.decode = function (reader, length, _end, _depth, _target) {
                ...
                message = _target || new $root.StatusAttributions.StatusAttribution.RLAttribution();
                while (reader.pos < end) {
                    var start = reader.pos;
                    var tag = reader.tag();
                    if (tag === _end) {
        ...
        StatusAttribution.StatusReshare = (function() {
            ...
            StatusReshare.decode = function (reader, length, _end, _depth, _target) {
                ...
                message = _target || new $root.StatusAttributions.StatusAttribution.StatusReshare();
                while (reader.pos < end) {
                    var start = reader.pos;
                    var tag = reader.tag();
                    if (tag === _end) {
            ...
            StatusReshare.Metadata = (function() {
                ...
                Metadata.decode = function (reader, length, _end, _depth, _target) {
                    ...
                    message = _target || new $root.StatusAttributions.StatusAttribution.StatusReshare.Metadata();
                    while (reader.pos < end) {
                        var start = reader.pos;
                        var tag = reader.tag();
                        if (tag === _end) {
